...
```bash
pip install "lab-drivers[all] @ git+https://github.com/unearth4334/lab-drivers.git@v0.2.0"
```
...
[project]
dependencies = [
  "lab-drivers[all] @ git+https://github.com/unearth4334/lab-drivers.git@v0.2.0",
]
```
